...
-- SOURCE /docker-entrypoint-initdb.d/red_river_climbs/dat/climb_grade_data.sql;
-- SOURCE dat/climb_grade_data.sql;

-- -- Populate owners table with preliminary list.
-- SOURCE /docker-entrypoint-initdb.d/red_river_climbs/dat/owner_data.sql;
-- SOURCE dat/owner_data.sql;

-- -- Populate regions list with current regions list.
-- SOURCE /docker-entrypoint-initdb.d/red_river_climbs/dat/region_data.sql;
-- SOURCE dat/region_data.sql;

-- -- Populate climbers with some climbers.
-- SOURCE /docker-entrypoint-initdb.d/red_river_climbs/dat/climber_data.sql;
-- SOURCE dat/climber_data.sql;

-- -- Populate the crags table with two regions's worth.
-- SOURCE /docker-entrypoint-initdb.d/red_river_climbs/dat/muir_valley_crag_data.sql;
-- SOURCE dat/muir_valley_crag_data.sql;
-- SOURCE /docker-entrypoint-initdb.d/red_river_climbs/dat/miller_fork_crag_data.sql;
-- SOURCE dat/miller_fork_crag_data.sql;

-- -- Populate the climbs table with some routes!
-- SOURCE /docker-entrypoint-initdb.d/red_river_climbs/dat/climb_data.sql;
-- SOURCE dat/climb_data.sql;

-- -- Include logic for the complicated process that is adding a new route.
-- SOURCE /docker-entrypoint-initdb.d/red_river_climbs/logic/add_new_climb.sql;
-- SOURCE logic/add_new_climb.sql;

-- -- Include example statements, some of which define views.
-- SOURCE /docker-entrypoint-initdb.d/red_river_climbs/examples/example_queries.sql;
-- SOURCE examples/example_queries.sql;
-- SOURCE /docker-entrypoint-initdb.d/red_river_climbs/examples/having_example.sql;
-- SOURCE examples/having_example.sql;
-- SOURCE /docker-entrypoint-initdb.d/red_river_climbs/examples/home_page_table.sql;
-- SOURCE examples/home_page_table.sql;
-- SOURCE /docker-entrypoint-initdb.d/red_river_climbs/examples/monastery_hist_query.sql;
-- SOURCE examples/monastery_hist_query.sql;
-- SOURCE /docker-entrypoint-initdb.d/red_river_climbs/examples/name_to_climber_id.sql;
